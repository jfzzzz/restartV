        ...
        <div slot="header">
          <el-form :inline="true" :model="formInline" class="demo-form-inline">
            <el-form-item label="角色">
              <el-select v-model="formInline.roid" @change="handleChangeSearch">
          ...
          >
            ...
            <el-table-column label="角色" >
              <template slot-scope="scope">
                ...
                <span v-else-if="scope.row.roidid == 7">（待定）</span>
              </template>
            </el-table-column>
            <el-table-column prop="roidRangeDis" label="拥有权限" ></el-table-column>
...
export default {
  created() {
    this.$http.get("/user/roidManager.json").then(res => {
