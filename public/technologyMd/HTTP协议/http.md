...
![http-protocol](/technologyMd/HTTP协议/media/http-protocol.png)
...
![request](/technologyMd/HTTP协议/media/request.png)

![request-structure](/technologyMd/HTTP协议/media/request-structure.png)
...
![response](/technologyMd/HTTP协议/media/response.png)
...
![HTTP请求和响应](/technologyMd/HTTP协议/media/chrome.png)
