...
![父组件向子组件传递普通数据](/technologyMd/vue/vue/media/父组件向子组件传递普通数据.png)
...
![子组件向父组件传值](/technologyMd/vue/vue/media/子组件向父组件传值.png)
...
![兄弟组件之间的数据传递](/technologyMd/vue/vue/media/兄弟组件之间的数据传递.png)
